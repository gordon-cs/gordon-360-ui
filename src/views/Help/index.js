  ...
  render() {
    return (
      <section>
        ...
        <Typography type="body1" gutterBottom component="ul">
          <li>
            <strong>My Activities</strong> – List of Current and Past Leadership or Memberships.
          ...
          <li>
            <strong>Profile Red Dot</strong> – You have Subscriber
        ...
        <Typography type="body1" gutterBottom component="ul">
          ...
          <li>
            <strong>Advisor</strong> – Faculty or Staff Advisor have the same privileges as
        ...
        <Typography type="body1" gutterBottom component="ul">
          ...
          <li>
            <strong>Subscriber</strong> – Subscribes to the Email Feed from your Leader or
            Advisor “Email Group” function. Subscribers cannot see Members on the
            Roster, but can see Group Information.
          </li>
          <li>
            <strong>Managing Requests</strong> – To receive a Subscriber or Membership request,
          ...
          <li>
            <strong>Description</strong> – Recommended 1-2 sentence Activity Group description,
        ...
        <Typography type="body1" gutterBottom component="ul">
          <li>
            <strong>Do I have to join a group each semester?</strong> Yes.
          ...
          <li>
            <strong>What if I leave a group?</strong> Subscribership and Membership
