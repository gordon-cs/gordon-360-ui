          ...
          <CardContent>
            ...
            <Card className="help-section">
              ...
              <CardContent>
                <Typography variant="body1" component="ul">
                  <li>
                    <strong>Home</strong> &ndash; Contains various tiles with charts or
                      information.
                      <Typography variant="body1" component="ul">
                      <li>
                        <strong>Student:</strong> Includes your Dining “Meal Wheel’ tracker synced
                          ...
                          credits. You can click on the CL&W tracker to see which events are
                          recorded for you.
                        </li>
                      <li>
                        <strong>Faculty/Staff:</strong> Includes days remaining wheel and a
                          separate Dining Dollars tracker.
                        </li>
                    </Typography>
                  </li>
                  <li>
                    <strong>Involvements</strong> &ndash; A list of available groups, clubs and
                      organizations for the current Academic Session. Change Academic Sessions in
                      the drop down menu to view involvements in other sessions. You can view your
                      pending join requests for Involvements you’ve requested, as well as the
                      requests that are pending for you approve if you are a Group Leader/Advisor.
                    </li>
                  <li>
                    <strong>Events</strong> &ndash; A live list of events drawn from the campus
                      ...
                      and/or time. Use the filters to narrow your search (including CL&W events if
                      you are looking for more).
                    </li>
                  <li>
                    <strong>People</strong> &ndash; Allows searching the campus community with
                      more in-depth filters than the normal search bar. You can filter students,
                      staff, and faculty by name or hall and by academic, home, and office info.
                    </li>
                  <li>
                    <strong>Quick Search</strong> &ndash; Quick searches by name of Gordon
                      students, faculty and staff. Just first name or last name is needed.
                    </li>
                  <li>
                    <strong>My Profile</strong> &ndash; Shows your own personal information –
                      ...
                      others to connect with you in the My Profile photo section. On Mobile, access
                      My Profile through the Navigation Drawer (three-line stack) or on Desktop by
                      ...
                      information will remain visible to faculty and staff even if you make it
                      private for student viewers. If you have a situation that requires additional
                      privacy or security, please contact CTS,
                ...
                <Typography variant="body1" component="ul">
                  ...
                  <li>
                    <strong>Advisor</strong> &ndash; Faculty or Staff Advisor have the same
                      privileges as Leaders. It is recommended to give an Advisor a position title
                      for the Roster.
                    </li>
                  <li>
            ...
            <Card className="help-section">
              ...
              <CardContent>
                <Typography variant="body1" component="ul">
                  <li>
                    <strong>Group Email</strong> &ndash; Leaders/Advisors can email the full
                      roster of Members, plus any Subscribers to their Communications feed. Allows
                      direct connection emails.
                    </li>
                  <li>
                  ...
                  <li>
                    <strong>Managing Requests</strong> &ndash; To manager a Subscriber or
                      Membership request, go to the home page, or open the Involvement you
                      Lead/Advise. New requests appear at the top of the roster. To modify a request
                      to a different user level, use the dropdown menu (Advisor, Leader, Member,
                      Subscriber) to assign a different level. Add an appropriate position title for
                      Leaders and Advisors. You can add a title to other users as well.
                    </li>
                  <li>
                    <strong>Title/Comment</strong> &ndash; Short but descriptive job or role title
                      that will appear on the Roster and the Experience Transcript. Helps manage
                      roles in large rosters. Recommended for Leader and Advisors, can be used for
                      anyone. These are public and appear as a detail for the Official Experience
                      Transcript!
                    </li>
                  <li>
                  ...
                  <li>
                    <strong>Description</strong> &ndash; Recommended 1-2 sentence Involvement
                      description, and place for updating meeting times and locations for
                      Involvement seekers, Subscribers, and Members.
                    </li>
                  <li>
                    <strong>Involvement Image</strong> &ndash; 72DPI, no larger than 320x320
                      pixels and 100KB or less. Recommend a square image for clearest quality.
                      Default image will fill where there is no Image loaded.
                    </li>
                </Typography>
              </CardContent>
            </Card>
            ...
            <Card className="help-section">
              ...
              <CardContent>
                <Typography variant="body1" component="ul">
                  <li>
                    Gordon 360 has been successfully tested on Windows (Edge, Firefox, Chrome),
                    Mac (Safari, Firefox, Chrome), and on Android and iPhone default browsers.
                    </li>
            ...
            <Card className="help-section">
              ...
              <CardContent>
                <Typography variant="body1" component="ul">
                  ...
                  <li>
                    <strong>
                      What&apos;s the difference between subscribing to, and joining an
                        Involvement?{' '}
                    </strong>
                      Subscribing to an Involvement allows you to receive emails from the
                      Involvement, but not to view other members of the Involvement. Joining a
                      Involvement means you're an active member of the Involvement. You can view
                      other members in the Involvement in addition to getting group emails.
                    </li>
                  <li>
                    <strong>What if I leave an Involvement?</strong> Subscribership and Membership
                      ...
                      session. You can come and go over the semester, and your Membership will move
                      to your official Experience Transcript only at the end of the semester.
                    </li>
                  <li>
                    <strong>
                      What if I am in an Involvement I don&apos;t want to be part of?{' '}
                    </strong>
                      No problem. Contact the Involvement leaders or advisor and they will be able
                  ...
                  <li>
                    <strong>
                      ...
                      We apologize, but alumni cannot join new Involvements. You could still
                      subscribe to Involvements to receive emails!
                    </li>
                </Typography>
              </CardContent>
            </Card>
