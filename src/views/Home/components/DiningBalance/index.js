    ...
    return (
      <Card>
        <CardContent>
          ...
          <Typography varaint="subheading" style={{ textAlign: 'center', paddingTop: 5 }}>
            {this.state.loading ? '' : 'Dining Balances are not currently displaying properly.  Thank you for your patience while we address this issue.'}
          </Typography>
          {content}
        </CardContent>
      </Card>
