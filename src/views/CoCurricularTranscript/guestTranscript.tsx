...
export const exampleStudentProfile: StudentProfileInfo = {
  ...
  ID: '12345678',
  Title: '',
  FirstName: { value: 'Example', isPrivate: false },
  MiddleName: { value: '', isPrivate: false },
  LastName: { value: 'Student', isPrivate: false },
  Suffix: { value: '', isPrivate: false },
  MaidenName: { value: '', isPrivate: false },
  NickName: { value: '', isPrivate: false },
  ...
  OnCampusFax: '',
  Mail_Location: '000',
  HomeStreet1: { value: '255 Grapevine Rd', isPrivate: false },
  HomeStreet2: { value: '', isPrivate: false },
  HomeCity: { value: 'Wenham', isPrivate: false },
  HomeState: { value: 'MA', isPrivate: false },
  HomePostalCode: { value: '', isPrivate: false },
  HomeCountry: { value: 'US', isPrivate: false },
  HomePhone: { value: '', isPrivate: false },
  HomeFax: '',
  KeepPrivate: '',
  ...
  show_pic: 0,
  preferred_photo: 0,
  Country: { value: 'United States of America', isPrivate: false },
  ...
  Minor2: '',
  Minor3: '',
  MobilePhone: { value: '123-456-7890', isPrivate: false },
