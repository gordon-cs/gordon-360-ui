...
const Timesheets = (props) => {
  return (
    <Card>
      <CardContent>
        <Typography variant="h4">Technical Difficulties</Typography>
        <Typography>
          We're experiencing technical difficulties. Timesheets on 360 is temporarily disabled.
          Please{' '}
          <a href="https://go.gordon.edu/student_timesheets/" className="temp-go-link">
            use the GO site
          </a>{' '}
          in the meantime. Contact CTS (CTS@gordon.edu) with any questions or issues.
        </Typography>
      </CardContent>
    </Card>
  );
  // Comment out this view for the time being, until we've debugged issue with NULL start and end times.
