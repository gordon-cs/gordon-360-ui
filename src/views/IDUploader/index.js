  ...
  render() {
              ...
              <Card raised={true}>
                <Grid item style={{ margin: '10px' }}>
                  <img
                    ...
                    className={styles.placeholder-id}
    ...
    return (
      <Grid container justifyContent="center" spacing={2}>
        ...
        >
          <div className={styles.gc360-id-dialog}>
            <DialogTitle className={styles.gc360-id-dialog_title} id="simple-dialog-title">
              Update ID Picture
            </DialogTitle>
            <DialogContent className={styles.gc360-id-dialog_content}>
              <DialogContentText className={styles.gc360-id-dialog_content_text}>
              ...
              {!preview && (
                ...
                >
                  {({ getRootProps, getInputProps }) => (
                    <section>
                      <div className={styles.gc360-id-dialog_content_dropzone} {...getRootProps()}>
                        <input {...getInputProps()} />
                        <img
                          className={styles.gc360-id-dialog_content_dropzone_img}
              ...
              {preview && (
                <div className={styles.gc360-id-dialog_content_cropper}>
                  <Cropper
                    ref={this.cropperRef}
                    src={preview}
                    style={{
              ...
              {preview && (
                <Button
                  ...
                  style={style.button}
                  className={styles.gc360-id-dialog_content_button}
                >
                  Choose Another Image
                </Button>
              )}
            </DialogContent>
            <DialogActions className={styles.gc360-id-dialog_actions}>
