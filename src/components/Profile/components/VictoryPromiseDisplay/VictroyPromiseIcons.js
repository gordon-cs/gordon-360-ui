...
export const ChristianCharacterIcon = ({ title, description, active }) => {
  return (
    <SVGIconWithTooltip title={title} description={description}>
      <g className={`${active ? styles.active : ''} ${styles.christian_character}`}>
        <polygon
...
export const IntellectualMaturityIcon = ({ title, description, active }) => {
  return (
    <SVGIconWithTooltip title={title} description={description}>
      <g className={`${active ? styles.active : ''} ${styles.intellectual_maturity}`}>
        <path
          fill="var(--icon-primary)"
...
export const LivesOfServiceIcon = ({ title, description, active }) => {
  return (
    <SVGIconWithTooltip title={title} description={description}>
      <g className={`${active ? styles.active : ''} ${styles.lives_of_service}`}>
        <path
...
export const LeadershipWorldwideIcon = ({ title, description, active }) => {
  return (
    <SVGIconWithTooltip title={title} description={description}>
      <g className={`${active ? styles.active : ''} ${styles.leadership_worldwide}`}>
        <path
          fill="var(--icon-primary)"
        ...
        <path
          fill="var(--icon-secondary)"
          d="m57.74,92.93l-17,0a1.52,1.52 0 1 1 0,-3l17,0a1.52,1.52 0 0 1 0,3"
        />
      </g>
    </SVGIconWithTooltip>
  );
