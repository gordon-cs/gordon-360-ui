 ...
 * @returns {emails[]} List of all emails for members in the activity
 */
 ...
 * @returns {emails[]} List of all emails for members in the activity during the session
 */
 ...
 *
 * @param {string} id Activity code
 * @returns {emails[]} List of all emails for leaders in the activity
 */
 ...
 * @param {string} id Activity code
 * @param {string} SessionId Activity code
 * @returns {emails[]} List of all emails for leaders in the activity during the session
 */
 ...
 *
 * @param {string} id Activity code
 * @returns {emails[]} List of all emails for advisors in the activity
 */
 ...
 * @param {string} id Activity code
 * @param {string} SessionId Activity code
 * @returns {emails[]} List of all emails for advisors in the activity during the session
 */
