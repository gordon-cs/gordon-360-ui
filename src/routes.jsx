...
const Housing = lazy(() => import('./views/ResLife'));
...
const Posters = lazy(() => import('./views/Posters'));
const CampusSafety = lazy(() => import('./views/LostAndFound'));
const Marketplace = lazy(() => import('./views/MarketPlace'));
const AdminMarketplaceThreads = lazy(() => import('views/MarketPlace/components/AdminPage'));
