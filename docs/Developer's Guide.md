...
1. Your local machine must be configured as an SSH host
   ...
   On MacOS, you may have to enable the SSH server in System Preferences. Follow [these instructions](https://support.apple.com/lt-lt/guide/mac-help/mchlp1066/mac) to do so.
